...
<section id="main-container" class="pb-4 main-container text-center project-area ">
    <div class="container">
        ...
        <div class="d-grid gap-4 mt-4">
            <a href="{{route('memReg')}}" target="_blank" class="btn btn-primary mb-1" style="font-size: 20px">PSA Members</a>
            <a href="#" class="btn btn-dark mb-1" style="font-size: 20px">Non-Members</a>
        </div>
    </div>
