    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input style="box-shadow: 2px 2px 3px gray; background-color: white; color: black; font-weight: bold; text-transform:uppercase" class="form-control form-control-name" name="name" id="name" placeholder="" type="text" wire:model="last_name" value={{$last_name}} >
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label style=" font-weight: 750; font-size: medium; color:white">First Name</label>
                <input style="box-shadow: 2px 2px 3px gray; background-color: white; color: black; font-weight: bold; text-transform:uppercase" class="form-control form-control-email" name="text" id="text" placeholder="" type="text" wire:model="first_name" value={{$first_name}}>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label style=" font-weight: 750; font-size: medium; color:white">Middle Initial</label>
                <input style="box-shadow: 2px 2px 3px gray; background-color: white; color: black; font-weight: bold; text-transform:uppercase" class="form-control form-control-email" name="text" type="text"  id="text" placeholder=""  wire:model="middle_initial" value={{$middle_initial}}  >
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
            <label style=" font-weight: 750; font-size: medium; color:white">Name of Hospital</label>
            <input style="box-shadow: 2px 2px 3px gray; background-color: white; color: black; font-weight: bold; " class="form-control form-control-subject" name="subject" id="subject" wire:model="hospitalName" placeholder="" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="col-md-4">
            ...
            <div class="form-check">
                <input style="color: white" class="form-check-input" type="radio" readonly name="radioGender" value = "male" id="male" wire:model="gender" required>
                <label style="color: white" class="form-check-label" for="male">
                    Male
                </label>
            </div>
            <div class="form-check">
                <input style="color: white" class="form-check-input" type="radio" name="radioGender" value = "female" id="female" wire:model="gender" required>
